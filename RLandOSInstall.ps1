#RLand OS Install V7
Write-Host 'Bienvenido al Instalador de RLand OS By TheRodrike'
Write-Host 'Es Recomendable tener los drivers actualizados antes de continuar'
Read-Host -Prompt 'Pulse Enter para Instalar'
...
if ($decision -eq 0) {
    ...
    if ($decision -eq 0) {
        ...
        Write-Host 'Puedes Personalizar la Taskbar Instalando TranslucentTB'
        Write-Host 'Consulte el Readme si le Interesa esta Opcion'
        Read-Host -Prompt "Pulse Enter Continuar"
    } else {
        Write-Host 'No'
    }
} else {
